...
use bittorrent_protocol::metainfo::error::ParseResult;
use bittorrent_protocol::metainfo::{Metainfo, MetainfoBuilder};
    ...
    S: AsRef<Path>,
{
    ...
    let builder = MetainfoBuilder::new()
        .set_created_by(Some("bittorrent-project_metainfo"))
