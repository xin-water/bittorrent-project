...
use crate::util::sha::{self, ShaHash, XorRep};
use rand;

use crate::dht::routing::bucket::{self, Bucket};
use crate::dht::routing::node::{Node, NodeStatus};
...
mod tests {
    ...
    use crate::dht::routing::bucket;
    use crate::dht::routing::node::Node;
    use crate::dht::routing::table::{self, BucketContents, RoutingTable};

    // TODO: Move into use crate::util crate
    ...
    fn positive_add_node_max_recursion() {
        ...
        let block_addrs = util_test::dummy_block_socket_addrs((bucket::MAX_BUCKET_SIZE + 1) as u16);
    ...
    fn positive_all_sorted_buckets() {
        ...
        let block_addrs = util_test::dummy_block_socket_addrs(bucket::MAX_BUCKET_SIZE as u16);
    ...
    fn negative_node_id_equal_table_id() {
        ...
        let node = Node::as_good(table_id.into(), util_test::dummy_socket_addr_v4());
        table.add_node(node);
