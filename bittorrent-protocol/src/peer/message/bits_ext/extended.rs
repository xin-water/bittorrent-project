...

    {
...

        {
            ...
            for (ext_id, &value) in builder.id_map.iter() {
                ben_id_map_access.insert(ext_id.id().as_bytes().into(), bt_ben_int!(value as i64));
            }
        }
